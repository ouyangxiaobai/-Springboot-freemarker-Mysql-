          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <div class="progress-bar" id="show-progress" role="progressbar" style="width: 0%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
                    0%
                  </div>
                </div>
                <!--开始-->
				<div class="loadfiletype">
					<div class="menu" style="display: none;">
						<ul class="nav nav-pills nav-stacked" style="padding:5px 0 5px 0;">
								...
								<li><a onclick="shareFile('/net_disk/share_file')" class="doshare" href="javascript:void(0)">分享</a></li>
								<li><a class="movefile" href="javascript:void(0)">移动到</a></li>
								<li><a class="copyfile" href="javascript:void(0)">复制到</a></li>
							...
							<div class="file-box" style="overflow-y: auto;">
								<div class="boxcontain" style="height: auto;">
										...
										<div class="file-one creatpath pathtextarea diplaynone" style="width: 144px;">
											...
											<div class="file-one" title="${folder.name}">
												<div class="file-img path" title="${folder.name}">
														<a href="list?folderId=${folder.id}">
															<img src="/admin/images/fileimg/Folder.png">
														</a>
												</div>
				...
				<div class="modal-body box no-padding" style="display: none;">
					...
					<div class="box-footer" style="text-align:right;">
						...
						<form action="/net_disk/mc_file" method="post">
							...
							<span type="submit" class="btn btn-primary" id="mc-file-btn"
								>确定</span>
...
function uploading(){
	...
	$("#show-progress").parent(".progress").show();
	uploadingFile('upload-file',function(data){
		lightyear.loading('hide');
		$("#show-progress").parent(".progress").hide();
		if(data.code == 0){
