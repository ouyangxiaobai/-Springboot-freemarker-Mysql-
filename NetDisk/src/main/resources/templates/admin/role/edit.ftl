              ...
              <div class="card-body">
                <form action="add" id="role-add-form" method="post" class="row">
                  ...
                  <div class="input-group m-b-10">
                   ...
                   <div class="input-group m-b-10">
                    <span class="input-group-addon">存储空间</span>
                    <input type="number" class="form-control required" id="storageSize" name="storageSize" value="${role.storageSize!""}" placeholder="请输入空间大小" tips="请填写空间大小" />
